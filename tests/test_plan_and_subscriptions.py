...
def test_handle_payment_from_webhook(paystack_api):
    api_response = {
    ...
    result = paystack_api.webhook.payment_made(api_response['data'],
                                               api_response['event'])
    assert result == {
        'amount': 100,
        'plan_object': {
...
def test_handle_succesfull_transfer_from_webhook(paystack_api):
    api_response = {
...
def test_handle_failed_transfer_from_webhook(paystack_api):
    api_response = {
